class SnakeGame {
  constructor() {
    ...
    this.soundEffects = {
      score: new Audio('/extra/snake/snake_files/score.mp3'),
      gameOver: new Audio('/extra/snake/snake_files/game-over.mp3')
    };
  ...
  endGame() {
    ...
    this.$startScreen.querySelector('.options h3').innerText = 'Ой!';
    this.$startScreen.querySelector('.options .end-score').innerText = `Счёт: ${this.game.score}`;
